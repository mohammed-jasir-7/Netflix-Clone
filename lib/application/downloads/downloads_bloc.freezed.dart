...
mixin _$DownloadsState {
  ...
  List<Downloads> get dowloads => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      isloading: null == isloading
          ...
          : isloading // ignore: cast_nullable_to_non_nullable
              as bool,
      dowloads: null == dowloads
          ? _value.dowloads
          : dowloads // ignore: cast_nullable_to_non_nullable
              as List<Downloads>,
...
class _$_DownloadsState implements _DownloadsState {
  const _$_DownloadsState(
      ...
      required final List<Downloads> dowloads,
      required this.downloadsFailureOrSuccessOption})
      : _dowloads = dowloads;

  @override
  final bool isloading;
  final List<Downloads> _dowloads;
  @override
  List<Downloads> get dowloads {
    if (_dowloads is EqualUnmodifiableListView) return _dowloads;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_dowloads);
  }
  ...
  @override
  String toString() {
    return 'DownloadsState(isloading: $isloading, dowloads: $dowloads, downloadsFailureOrSuccessOption: $downloadsFailureOrSuccessOption)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._dowloads, _dowloads) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      isloading,
      const DeepCollectionEquality().hash(_dowloads),
      downloadsFailureOrSuccessOption);
